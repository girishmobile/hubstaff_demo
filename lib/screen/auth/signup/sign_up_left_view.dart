          ...
          children: [
            ...
            Container(
              margin: const EdgeInsets.only(
                  left: fifty, right: fifty, bottom: twenty),
              child: Column(
                ...
                children: [
                  ...
                  CommonTextWidget(
                    ...
                    fontSize: isMobile ? twenty : thirty,
                    color: Colors.black,
                  ),
                  CommonTextWidget(
                    text: productivityPersonifiedDesc,
                    fontSize: isMobile ? sixteen : seventeen,
                        ...
                        child: Text.rich(
                          TextSpan(
                            children: [
                              ...
                              TextSpan(
                                  text: ' $and ', style: commonTextStyle()),
                              TextSpan(
                                text: dpa,
                                style: commonTextStyle(
                                    fontWeight: FontWeight.bold),
                    ...
                    children: [
                      ...
                      Text.rich(
                        TextSpan(
                          children: [
                            TextSpan(
                                text: subjectDesc, style: commonTextStyle()),
                            TextSpan(
                              text: bba,
                              style: commonTextStyle(
                                  fontWeight: FontWeight.bold,
